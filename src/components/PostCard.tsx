                ...
                <div className="flex items-center justify-between px-4 pt-0 pb-1">
                  ...
                  <button 
                    ...
                    className={`p-2 -mr-2 rounded-full group transition-colors ${
                      isSaved ? 'text-violet-500' : 'text-zinc-500 dark:text-zinc-400 hover:text-violet-500 hover:bg-violet-500/10'
                    }`}
                  >
                              ...
                              >
                                ...
                                <div className="h-16 shrink-0 flex items-center justify-between px-2 border-b border-black/5 dark:border-white/5">
                                    ...
                                    <div className="flex items-center gap-1">
                                      ...
                                      <button
                                        onClick={handleSavePost}
                                        className={`p-2 rounded-full transition-colors ${isSaved ? 'text-violet-500' : 'text-zinc-500 hover:text-violet-500 hover:bg-violet-500/10'}`}
                                      >
