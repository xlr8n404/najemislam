      ...
      {open && (
        <div key="main-menu-overlay" className="fixed inset-0 z-[70]">
          ...
          >
            ...
            <div className="shrink-0 h-16 flex items-center px-3 border-b border-zinc-100 dark:border-zinc-900">
              <div
            ...
            {/* ── FIXED: Trending / Explore pills (only on home feed) ── */}
            {onFeedModeChange && (
              <div className="shrink-0 h-16 flex items-center gap-3 px-4 border-b border-zinc-100 dark:border-zinc-900">
                <button
            ...
            {/* ── FIXED: Nav shortcuts ── */}
            <div className="shrink-0 h-16 flex items-center justify-around px-2 border-b border-zinc-100 dark:border-zinc-900">
              {[
