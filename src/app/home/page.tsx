  ...
  return (
    ...
    >
      ...
      />
       ...
       <header className={`fixed top-0 left-0 right-0 h-16 z-50 px-4 bg-white dark:bg-black border border-black/10 dark:border-white/10 rounded-b-[24px] transition-transform duration-300 ${
